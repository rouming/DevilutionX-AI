...
The short video at the top of this README shows the agent managing to
find the next elvel in an environment with monsters disabled. It runs on
three randomly generated levels with default seed 0 (more on
replicating the results below), and the pretrained model used there
reaches a success rate of 0.98.
